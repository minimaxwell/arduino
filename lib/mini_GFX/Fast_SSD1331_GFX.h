/*************************************************** 
  ...
  Perf improvements by M.Chevallier, by implementing HW accelerated methods, such as copy, move, etc.
...
class Fast_SSD1331_GFX : public virtual Fast_Common_GFX {
 public:
  Fast_SSD1331_GFX(uint8_t CS, uint8_t RS, uint8_t SID, uint8_t SCLK, uint8_t RST);
  Fast_SSD1331_GFX(uint8_t CS, uint8_t RS, uint8_t RST);
  ...
  void copyRect(int16_t x_orig , int16_t y_orig, int16_t w, int16_t h, int16_t x_dest, int16_t y_dest);
